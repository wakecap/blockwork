...
export default {
  ...
  theme: {
    // Base font size and screen breakpoints
    fontSize: {
    ...
    extend: {
      ...
      colors: {
        ...
        // WakeCap Brand Colors
        wakecap: {
          primary: "hsl(var(--wakecap-primary))",
          "primary-foreground": "hsl(var(--wakecap-primary-foreground))",
          secondary: "hsl(var(--wakecap-secondary))",
          "secondary-foreground": "hsl(var(--wakecap-secondary-foreground))",
        ...
        // Primary Brand Colors (Orange theme based on your existing usage)
        orange: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
        ...
        // Secondary/Neutral Colors (Gray scale)
        gray: {
          50: '#f9fafb',
          100: '#f3f4f6',
          200: '#e5e7eb',
