  ...
  render: (args) => {
    ...
    return (
      <div className="flex gap-4">
        <Checkbox {...args} checked={checked[0]} onChange={() => setChecked([!checked[0], checked[1]])} label="Option 1" name="group2" />
        <Checkbox {...args} checked={checked[1]} onChange={() => setChecked([checked[0], !checked[1]])} label="Option 2" name="group2" />
      </div>
    );
  },
  args: {
