...
const meta: Meta<typeof CommentThread> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A comprehensive comment system with threading, replies, likes, and moderation features.",
      },
    },
  },
  tags: ["autodocs"],
...
const sampleComments: Comment[] = [
  ...
  },
  {
    ...
    content:
      "I have a different perspective on this topic. While the article makes good points, I think there are some areas that could be improved.",
...
const blogPostComments: Comment[] = [
  {
    ...
    avatar:
      "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
    content:
      "This tutorial saved me hours of debugging! The step-by-step approach was exactly what I needed.",
    timestamp: new Date(Date.now() - 7200000),
    likes: 24,
    dislikes: 0,
    isLiked: true,
  ...
  },
  {
    ...
    avatar:
      "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
    content:
      "Great content! As someone who's been in the industry for 10+ years, I appreciate how you've made complex concepts accessible to beginners.",
