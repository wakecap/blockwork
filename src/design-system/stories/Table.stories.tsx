...
const meta: Meta<typeof Table> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A powerful data grid component built with AG Grid, featuring sorting, filtering, row selection, pagination, and advanced data manipulation capabilities.",
      },
    },
  },
  tags: ["autodocs"],
    ...
    return (
      <div>
        ...
        <div className="mb-4">
          ...
          <Table columns={simpleColumns} data={simpleData} height={200} className="w-full" />
        </div>
        <div>
          <h3 className="font-bold">Full Test:</h3>
          <Table columns={columns} data={sampleData} height={400} className="w-full" />
        </div>
      </div>
    );
  },
    ...
    return (
      <div>
        ...
        <div className="mb-4 p-4 bg-yellow-100 rounded">
          <p>
            <strong>CSS Classes Applied:</strong>
          </p>
    ...
    return (
      <div>
        ...
        <div
          ...
          style={{ height: 300, width: "100%", border: "2px solid red" }}
        >
          <AgGridReact
            columnDefs={columnDefs}
            rowData={rowData}
        ...
        <div className="mt-4 p-4 bg-gray-100 rounded">
          <p>
            <strong>Expected:</strong> You should see a red border around the grid area
          </p>
          <p>
            <strong>If empty:</strong> Check console for errors
          </p>
        </div>
      </div>
    );
