...
const meta: Meta<typeof PageLoading> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A full-screen loading component with the Wakecap logo that fades in and out with smooth animation.",
      },
    },
  },
  argTypes: {
    ...
    logoVariant: {
      ...
      options: ["symbol", "text"],
      description:
        "Logo variant to display - symbol for geometric symbol or text for full Wakecap text logo",
    },
  },
};
