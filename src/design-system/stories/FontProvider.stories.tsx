...
const meta: Meta<typeof FontProvider> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A font provider that allows switching between English (Figtree) and Arabic (IBM Plex Sans Arabic) fonts with RTL support.",
      },
    },
  },
  tags: ["autodocs"],
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-4 border rounded-lg">
              ...
              <ArabicText className="text-base">
                النص السريع البني يقفز فوق الكلب الكسول. هذا نص تجريبي لإظهار عائلة الخط IBM Plex
                Sans Arabic.
              </ArabicText>
            </div>
          </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-lg mb-4">هذا يوضح كيف تتغير عائلة الخط بناءً على اللغة المختارة.</p>
          </div>
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="p-6 border rounded-lg bg-white">
          ...
          <div className="mt-4 p-3 bg-neutral-50 rounded text-sm">
            <strong>Font Family:</strong> Figtree
            <br />
        ...
        <div className="p-6 border rounded-lg bg-white">
          ...
          <div className="mt-4 p-3 bg-neutral-50 rounded text-sm">
            <strong>Font Family:</strong> IBM Plex Sans Arabic
            <br />
      ...
      <div className="p-6 bg-neutral-50 rounded-lg">
        ...
        <ul className="space-y-2 text-sm text-neutral-700">
          <li>
            • Use <code className="bg-white px-1 py-0.5 rounded text-xs">font-sans</code> for
            English text (Figtree)
          </li>
          <li>
            • Use <code className="bg-white px-1 py-0.5 rounded text-xs">font-arabic</code> for
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="p-6 border rounded-lg">
            ...
            <p className="text-base leading-relaxed mb-4">
              ...
              switch between Figtree (English) and IBM Plex Sans Arabic (Arabic) based on your
              selection.
            </p>
            <p className="text-base leading-relaxed">
              You can see how the typography changes, including character spacing, line height, and
              overall readability for each language.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-4 border rounded-lg">
              ...
              <div className="space-y-1 text-sm">
                <div>
                  Font Family:{" "}
                  <span className="font-mono bg-neutral-100 px-1 rounded">Current</span>
                </div>
                <div>
                  Line Height: <span className="font-mono bg-neutral-100 px-1 rounded">1.5</span>
                </div>
                <div>
                  Letter Spacing:{" "}
                  <span className="font-mono bg-neutral-100 px-1 rounded">Normal</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 border rounded-lg">
              ...
              <div className="space-y-1 text-sm">
                <div>
                  Text Direction:{" "}
                  <span className="font-mono bg-neutral-100 px-1 rounded">Auto</span>
                </div>
                <div>
                  Font Loading:{" "}
                  <span className="font-mono bg-neutral-100 px-1 rounded">Optimized</span>
                </div>
                <div>
                  Fallback: <span className="font-mono bg-neutral-100 px-1 rounded">System</span>
                </div>
              </div>
            </div>
          </div>
