          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {section.colors.map((color) => (
              <div key={color.name} className="flex flex-col">
                <div className={`h-16 w-full rounded-lg border border-border ${color.class}`} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {elevations.map((elevation) => (
            <div key={elevation.name} className="space-y-2">
              <div
                className={`h-20 bg-card rounded-lg border border-border ${elevation.class} flex items-center justify-center`}
              >
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {customElevations.map((elevation) => (
            <div key={elevation.name} className="space-y-2">
              <div
                className={`h-20 bg-card rounded-lg ${elevation.class} flex items-center justify-center`}
              >
                <span className="text-sm font-mono text-muted-foreground">{elevation.name}</span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        {borderRadii.map((radius) => (
          <div key={radius.name} className="space-y-2">
            <div
              className={`h-16 w-full bg-accent border-2 border-primary ${radius.class} flex items-center justify-center`}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {animations.map((animation) => (
            <div key={animation.name} className="space-y-2">
              ...
              <div
                className={`h-16 bg-accent rounded-lg flex items-center justify-center ${animation.class}`}
              >
