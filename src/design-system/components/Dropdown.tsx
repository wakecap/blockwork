...
export const Dropdown: React.FC<DropdownProps> = ({ label, options, value, onChange, className, disabled, iconLeft, iconRight, ...props }) => (
  <div className="w-full font-sans">
    ...
    <div className="relative flex items-center">
      ...
      {iconRight && <span className="absolute right-3 text-neutral-400 pointer-events-none"><FontAwesomeIcon icon={iconRight} className="w-4 h-4" /></span>}
    </div>
  </div>
); 