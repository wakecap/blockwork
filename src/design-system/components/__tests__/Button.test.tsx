...
import { faBell, faDownload, faSpinner, faCheck, faTimes } from "@fortawesome/free-solid-svg-icons";
...
describe("Button Component", () => {
  ...
  describe("Loading State", () => {
    it("shows loading spinner when loading", () => {
      ...
      const spinner = button.querySelector(
        '[data-testid="font-awesome-icon"][data-icon="spinner"]',
      );
  ...
  describe("Icon Positioning", () => {
    ...
    it("positions icon on the right when specified", () => {
      render(
        <Button icon={faBell} iconPosition="right">
          With Icon
        </Button>,
        { wrapper: TestWrapper },
      );
  ...
  describe("RTL/Arabic Support", () => {
    ...
    it("flips icon position in RTL mode", () => {
      render(
        <Button icon={faBell} iconPosition="left" arabicText="إشعارات" showArabicText={true}>
          Notifications
        </Button>,
        { wrapper: TestWrapper },
      );
  ...
  describe("Special States", () => {
    it("applies pinned state styling", () => {
      render(
        <Button variant="pin" isPinned={true}>
          Pinned
        </Button>,
        { wrapper: TestWrapper },
      );
  ...
  describe("Accessibility", () => {
    it("has proper ARIA label for icon-only buttons", () => {
      render(<Button size="icon" icon={faBell} aria-label="Notifications" />, {
        wrapper: TestWrapper,
      });
    ...
    it("has proper ARIA described by attribute", () => {
      render(<Button aria-describedby="help-text">Button</Button>, { wrapper: TestWrapper });
  ...
  describe("Custom Styling", () => {
    ...
    it("merges custom styles with default styles", () => {
      render(
        <Button className="custom-class" style={{ backgroundColor: "red" }}>
          Styled
        </Button>,
        { wrapper: TestWrapper },
      );
