...
describe('Button Visual Regression Tests', () => {
  ...
  describe('Icon Rendering', () => {
    it('renders icon on the left correctly', () => {
      render(<Button icon={faDownload} iconPosition="left">Download</Button>, { wrapper: TestWrapper });
    ...
    it('renders icon on the right correctly', () => {
      render(<Button icon={faUpload} iconPosition="right">Upload</Button>, { wrapper: TestWrapper });
    ...
    it('renders multiple icons correctly', () => {
      render(
        <div>
          <Button icon={faCheck} variant="success">Success</Button>
          <Button icon={faTimes} variant="destructive">Delete</Button>
          <Button icon={faBell} variant="info">Notify</Button>
        </div>,
        { wrapper: TestWrapper }
      );
  ...
  describe('State Rendering', () => {
    ...
    it('renders pinned state correctly', () => {
      render(<Button variant="pin" isPinned>Pinned</Button>, { wrapper: TestWrapper });
  ...
  describe('Edge Cases', () => {
    it('handles very long text correctly', () => {
      render(
        <Button>
          This is a very long button text that should wrap or truncate appropriately
        </Button>,
        { wrapper: TestWrapper }
      );
