...
import { Timeline, ActivityTimeline, ProjectTimeline, EventTimeline } from "./Timeline";
  ...
  render: () => (
    <div className="space-y-8">
      ...
      <div>
        ...
        <Timeline items={sampleItems.slice(0, 3)} variant="compact" className="w-full max-w-2xl" />
      </div>
      <div>
        <h3 className="text-sm font-medium text-neutral-700 mb-4">Detailed Variant</h3>
        <Timeline items={sampleItems.slice(0, 3)} variant="detailed" className="w-full max-w-2xl" />
      </div>
    </div>
  ),
};
  ...
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <div className="text-sm text-neutral-600">Selected: {selectedItem || "None"}</div>
        <Timeline
          items={sampleItems}
