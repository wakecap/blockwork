...
import { OTPInput, PINInput, VerificationCode, PasswordOTP, useOTP } from "./OTPInput";
...
const meta: Meta<typeof OTPInput> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A One-Time Password (OTP) input component for verification codes, PINs, and secure authentication.",
      },
    },
  },
  tags: ["autodocs"],
...
export const Default: Story = {
  render: () => {
    ...
    return <OTPInput value={value} onChange={setValue} className="w-full max-w-md" />;
  },
};
  ...
  render: () => {
    ...
    return (
      <div className="w-full max-w-md">
        ...
        <PINInput value={value} onChange={setValue} length={4} size="lg" autoFocus />
      </div>
    );
  },
};
  ...
  render: () => {
    ...
    return (
      <div className="w-full max-w-md">
        ...
        <VerificationCode value={value} onChange={setValue} length={6} size="md" autoFocus />
      </div>
    );
  },
};
...
export const Small: Story = {
  render: () => {
    ...
    return <OTPInput value={value} onChange={setValue} size="sm" className="w-full max-w-md" />;
  },
};
...
export const Large: Story = {
  render: () => {
    ...
    return <OTPInput value={value} onChange={setValue} size="lg" className="w-full max-w-md" />;
  },
};
...
export const Outlined: Story = {
  render: () => {
    ...
    return (
      <OTPInput value={value} onChange={setValue} variant="outlined" className="w-full max-w-md" />
    );
  },
};
...
export const Filled: Story = {
  render: () => {
    ...
    return (
      <OTPInput value={value} onChange={setValue} variant="filled" className="w-full max-w-md" />
    );
  },
};
...
export const EightDigits: Story = {
  render: () => {
    ...
    return <OTPInput value={value} onChange={setValue} length={8} className="w-full max-w-md" />;
  },
};
...
export const Disabled: Story = {
  render: () => {
    return (
      <OTPInput value="123456" onChange={() => {}} disabled={true} className="w-full max-w-md" />
    );
  },
};
  ...
  render: () => {
    ...
    return (
      <div className="w-full max-w-md">
        ...
        <OTPInput value={value} onChange={setValue} onComplete={handleComplete} autoFocus />
        {isComplete && (
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-white border border-neutral-200 rounded-lg p-4">
            ...
            <VerificationCode value={otp1} onChange={setOtp1} length={6} size="md" />
            {isComplete1 && <div className="mt-2 text-sm text-green-600">✓ Verified</div>}
          </div>

          <div className="bg-white border border-neutral-200 rounded-lg p-4">
            <h3 className="text-lg font-medium text-neutral-900 mb-4">SMS Code</h3>
            <OTPInput value={otp2} onChange={setOtp2} length={4} size="md" type="number" />
            {isComplete2 && <div className="mt-2 text-sm text-green-600">✓ Verified</div>}
          </div>

          <div className="bg-white border border-neutral-200 rounded-lg p-4">
            <h3 className="text-lg font-medium text-neutral-900 mb-4">Security Token</h3>
            <PasswordOTP value={otp3} onChange={setOtp3} length={8} size="sm" showToggle={true} />
            {isComplete3 && <div className="mt-2 text-sm text-green-600">✓ Verified</div>}
          </div>
        </div>
      </div>
    );
