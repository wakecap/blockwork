...
import { SignatureInput, DocumentSignature, CompactSignature } from "./SignatureInput";
...
const meta: Meta<typeof SignatureInput> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A signature input component using HTML canvas for capturing user signatures with drawing tools and history management.",
      },
    },
  },
  tags: ["autodocs"],
...
export const Default: Story = {
  render: () => {
    ...
    return (
      <SignatureInput value={signature} onChange={setSignature} className="w-full max-w-2xl" />
    );
  },
};
    ...
    return (
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg p-6">
          ...
          <DocumentSignature value={signature} onChange={setSignature} />
    ...
    return (
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg p-4">
          ...
          <CompactSignature value={signature} onChange={setSignature} />
        </div>
      </div>
    );
  },
    ...
    return (
      <div className="w-full max-w-md mx-auto">
        ...
        <div className="bg-white border border-neutral-200 rounded-lg p-4">
          ...
          <p className="text-sm text-neutral-600 mb-4">Use your finger or stylus to sign below</p>
          <SignatureInput
            value={signature}
            onChange={setSignature}
            width={300}
