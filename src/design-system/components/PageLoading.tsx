          ...
          {logoVariant === 'symbol' ? (
            ...
            >
              <path 
                ...
                style={{
                  animation: skeleton ? 'none' : `colorFade ${animationDuration}ms ease-in-out infinite`
                }}
              />
            </svg>
          ) : (
          ...
          {skeleton && (
            <div
              style={{
                ...
                width: '100%',
                height: '100%',
                background: 'linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.4), rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.4), rgba(255, 255, 255, 0.2), transparent)',
