...
export const InfoTooltip: React.FC<{
  ...
  <Tooltip content={content} variant="light" size="sm" className={className}>
    {children}
  </Tooltip>
);
...
export const HelpTooltip: React.FC<{
  ...
  <Tooltip content={content} variant="default" size="md" className={className}>
    {children}
  </Tooltip>
);
...
export const ErrorTooltip: React.FC<{
  ...
  <Tooltip content={content} variant="dark" size="sm" className={className}>
    {children}
  </Tooltip>
);
