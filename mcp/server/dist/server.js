...
export const COMPONENTS = {
    TopNavigator: {
        name: "TopNavigator",
        description: "Top navigation bar with project selector, menu dropdown, pinned items, and avatar menu. Production-ready component for construction project applications.",
        category: "Navigation",
    ...
    Button: {
        name: "Button",
        description: "Versatile button component with 14 style variants, 11 sizes, icon support, loading states, and full RTL/Arabic support. Production-ready for forms and UI interactions.",
        category: "Forms",
        path: "src/design-system/components/Button/Button.tsx",
        props: {
            variant: "'primary' | 'secondary' | 'accent' | 'outline' | 'ghost' | 'text' | 'success' | 'warning' | 'destructive' | 'info' | 'pin' | 'nav' | 'fab' | 'iconBtn' - Button style variant (default: 'primary')",
            ...
            iconPosition: "'left' | 'right' (optional) - Icon position relative to text (default: 'left', auto-flips in RTL)",
            loading: "boolean (optional) - Show loading spinner and disable interactions (default: false)",
            ...
            showArabicText: "boolean (optional) - Display Arabic text and enable RTL layout with IBM Plex Sans Arabic font",
    ...
    Avatar: {
        name: "Avatar",
        description: "User avatar component with multiple sizes, status indicators, fallback support, and click interactions. Production-ready for user profiles and navigation.",
        ...
        props: {
            ...
            statusPosition: "'top-right' | 'top-left' | 'bottom-right' | 'bottom-left' (optional) - Position of status indicator (default: 'bottom-right')",
    ...
    Badge: {
        name: "Badge",
        description: "Versatile badge component with 7 variants and 3 sizes for labels, status, and categorization. Production-ready for UI annotations.",
        category: "UI Components",
        path: "src/design-system/components/Badge/Badge.tsx",
        props: {
            variant: "'default' | 'secondary' | 'destructive' | 'outline' | 'success' | 'warning' | 'info' (optional) - Badge style variant (default: 'default')",
    ...
    EmptyState: {
        name: "EmptyState",
        description: "Empty state component for displaying helpful messages when no content is available. Production-ready with customizable icons, actions, and variants.",
        category: "UI Components",
        ...
        props: {
            ...
            variant: "'default' | 'search' | 'files' | 'users' | 'error' (optional) - Preset variant with default icon (default: 'default')",
    ...
    PageLoading: {
        name: "PageLoading",
        description: "Full-screen loading component with WakeCap logo animation and customizable message. Production-ready for app initialization and route transitions.",
        category: "UI Components",
        ...
        props: {
            ...
            animationDuration: "number (optional) - Duration of fade animation in milliseconds (default: 2000)",
            skeleton: "boolean (optional) - Use skeleton loading instead of fade animation (default: false)",
    ...
    Input: {
        name: "Input",
        description: "Standard text input field with label, icons, error/success states, and full Arabic/RTL support. Production-ready for all form input needs.",
    ...
    PasswordInput: {
        name: "PasswordInput",
        description: "Password input field with toggle visibility button, optional strength indicator, and error/success states. Production-ready for authentication forms.",
        category: "Input Fields",
    ...
    SearchInput: {
        name: "SearchInput",
        description: "Search-specific input field with magnifying glass icon, clear button, and Enter key search callback. Production-ready for search functionality.",
        category: "Input Fields",
    ...
    TextArea: {
        name: "TextArea",
        description: "Multi-line textarea input with character counter, icons, and error/success states. Production-ready for long-form text input.",
        category: "Input Fields",
    ...
    OTPInput: {
        name: "OTPInput",
        description: "One-time password input with individual digit fields, paste support, keyboard navigation, and password mode. Includes pre-built variants: PINInput, VerificationCode, PasswordOTP.",
        category: "Input Fields",
    ...
    Dropdown: {
        name: "Dropdown",
        description: "Native HTML select dropdown wrapper with Tailwind styling, label support, and icon positioning. Production-ready for selection inputs.",
        category: "Selection",
    ...
    Autocomplete: {
        name: "Autocomplete",
        description: "Text input with real-time filtering suggestions dropdown, keyboard navigation, and disabled option support. Production-ready for searchable selections.",
        category: "Selection",
    ...
    MultiSelect: {
        name: "MultiSelect",
        description: "Multi-select dropdown with checkbox indicators, removable tags/chips, optional search, and max selections limit. Production-ready for multi-selection needs.",
        category: "Selection",
    ...
    Checkbox: {
        name: "Checkbox",
        description: "Simple checkbox wrapper with label and optional icon support. Production-ready for boolean selections.",
        category: "Selection",
    ...
    Radio: {
        name: "Radio",
        description: "Simple radio button wrapper with label and optional icon support. Production-ready for mutually exclusive selections.",
        category: "Selection",
    ...
    Toggler: {
        name: "Toggler",
        description: "Custom switch/toggle component with smooth animations, icon support, and accessible design. Production-ready for on/off states.",
        category: "Selection",
    ...
    Calendar: {
        name: "Calendar",
        description: "Comprehensive calendar component with single/range/multi-month variants, date restrictions, predefined ranges, and locale support. Includes DatePicker and DateRangePicker.",
        category: "Date & Time",
    ...
    ColorPicker: {
        name: "ColorPicker",
        description: "Color selection component with multiple formats (hex/RGB/HSL), preset colors, preview, and contrast calculation. Includes pre-built variants and custom hook.",
        category: "Visual",
    ...
    Slider: {
        name: "Slider",
        description: "Simple HTML5 range input wrapper with label and current value display. Production-ready for numeric value selection.",
        category: "Numeric",
    ...
    RatingStars: {
        name: "RatingStars",
        description: "Star rating component with hover preview, multiple star counts (5/10), three variants, custom colors, and rating labels. Includes pre-built variants and custom hook.",
        category: "Rating",
    ...
    FileUpload: {
        name: "FileUpload",
        description: "Drag-and-drop file upload with progress bars, file type icons, error handling, and retry capability. Includes pre-built variants for images/documents/videos.",
        category: "File",
        path: "src/design-system/components/FileUpload/FileUpload.tsx",
        props: {
            files: "FileUploadFile[] (required) - Array of file objects with id/name/size/type/progress/status/error",
            ...
            variant: "'default' | 'compact' | 'detailed' (optional) - Layout variant (default: 'default')",
    ...
    SignatureInput: {
        name: "SignatureInput",
        description: "Canvas-based signature drawing with undo/redo, clear, download, and touch/mouse support. Includes pre-built variants for different sizes.",
        category: "Document",
    ...
    RichTextEditor: {
        name: "RichTextEditor",
        description: "Rich text editor with WYSIWYG and Markdown modes, customizable toolbar, and preview. Includes pre-built variants for different use cases.",
        category: "Text",
        ...
        props: {
            ...
            readOnly: "boolean (optional) - Read-only mode (default: false)",
            toolbar: "string[] (optional) - Toolbar items: bold, italic, underline, strikethrough, heading, list, orderedList, quote, code, link (default: all)",
        },
        features: [
    ...
    FormLayout: {
        name: "FormLayout",
        description: "Hierarchical form structure with groups, sections, and fields. Supports collapsible sections, multiple layouts, and validation display. Includes pre-built forms.",
        category: "Layout",
        ...
        props: {
            ...
            variant: "'default' | 'compact' | 'spacious' (optional) - Spacing variant (default: 'default')",
            layout: "'vertical' | 'horizontal' | 'two-column' (optional) - Layout mode (default: 'vertical')",
...
`;
    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        if (name === "get_usage_example") {
            const { componentName, variant, size } = args;
            const component = COMPONENTS[componentName];
            if (!component) {
                return {
                    content: [
...
<${componentName} />`;
        ...
        if (name === "get_design_token") {
            ...
            const tokenInfo = DESIGN_TOKENS[tokenType];
            if (!tokenInfo) {
                return {
                    content: [
                        {
