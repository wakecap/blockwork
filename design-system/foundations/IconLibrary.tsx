...
import { 
  faHeart, faUser, faCog, faSearch, faBell, faHome, faEnvelope, faPhone,
  faCheck, faTimes, faExclamation, faInfo, faPlus, faMinus, faEdit,
  faTrash, faSave, faDownload, faUpload, faPrint, faShare, faCopy
        ...
        <div key={category.title}>
          ...
          <div className="grid grid-cols-6 gap-4">
            {category.icons.map((iconItem) => (
              <div key={iconItem.name} className="flex flex-col items-center p-3 border border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors">
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      {colors.map(({ color, label }) => (
        <div key={color} className="flex items-center gap-3 p-3 border border-neutral-200 rounded-lg">
