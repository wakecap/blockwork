...
import { BottomSheet, ActionSheet, FormBottomSheet } from '../components/BottomSheet';
import { Button } from '../components/Button';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faCamera, faImage, faFile, faTrash, faEdit, faShare } from '@fortawesome/free-solid-svg-icons';
...
const meta: Meta<typeof BottomSheet> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A mobile-first bottom sheet component with drag-to-dismiss functionality and various variants.',
      },
    },
  },
  tags: ['autodocs'],
          ...
          >
            <div className="p-6">
              ...
              <div className="flex space-x-3 mt-6">
                <Button onClick={() => setOpenVariant(null)}>
                  Close
                </Button>
                <Button variant="outline" onClick={() => alert('Action performed!')}>
                  Action
